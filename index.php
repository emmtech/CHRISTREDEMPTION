...
<nav id="myNavbar" class="navbar navbar-default navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="#">The Sacred C &amp; S Church, Christ Redemption International</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="nav navbar-nav">
                 <li class="active"><a href=""><span></span>Home</a></li> 
                    <li><a href="web/wordoflife.php"><span></span>The Message</a></li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="../ourprogrammes/programmes.php"><span></span>Order of Service</a></li>
                        </ul>
                    </li>
                    <li><a href="web/sowseed.php"><span></span>Sow Seed</a></li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="web/aboutcherubimandseraphimchurch.php"><span></span>The C & S Church History</a></li>
                        </ul>
                    </li>
                    <li><a href="web/contact-us.php"><span></span>Contact Us</a></li>
            </ul>
        </div>
    </div>
</nav>
<div class="container">
    <div class="jumbotron">
        <img class="img-responsive" src="images/church.jpg" width="100%" height="200"/>
    </div>
     <div class="row">
        <div class="col-lg-12">
            <h2>Welcome Message</h2>
            <p>I Supt. Apostle J.O Olabisi welcome you in the name of the Lord. I pray may you needs be met at all times in Jesus name. I thank God for He has giving us everything we ask for. </p>
        </div>
    </div>
    <hr>
    <div class="container">
            ...
            <div class="breadcrumb">
               <div id="test1">
                ...
                <div id="test2" style="display:none">
                    ...
                    <p style="font-family:serif"><img src="images/avatar1.png" width="50" height="50"/>Glory be to God Almighty for His benevelonce and love for promoting me at my place of work and giving me a new bouncing baby boy.</p>
